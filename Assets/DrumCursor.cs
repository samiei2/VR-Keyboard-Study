...
public class DrumCursor : MonoBehaviour
{
    ...
    Vector3 cursorScale = new Vector3(0.2f, 0.2f, 0.2f);
    ...
    void Start()
    {
        ...
        if (showCursor)
        {
            ...
            Material headMaterial = new Material(Shader.Find("Unlit/Color"));
            headMaterial.SetColor("_Color", new Color(219, 219, 219,255));
            cursor.GetComponent<MeshRenderer>().material = headMaterial;
            ...
            cursor.AddComponent<DrumEvents>();
            cursor.layer = 2;
        }
